...
class nfa_dfa_zxhdfa:
    ...
    def creat_NFA(self, c):
        ...
        headnode.next_nodes.append(tailnode)
    ...
    def draw_nfa(self):
        f = gv.Digraph('C:/Users/YL139/Desktop/byyl/test/byxt/NFA_DFA_zxhdfa/NFA', format="png")
        f.attr(rankdir='LR')
    ...
    def draw_dfa(self):
        ...
        f = gv.Digraph('C:/Users/YL139/Desktop/byyl/test/byxt/NFA_DFA_zxhdfa/DFA', format="png")
    ...
    def draw_zxhdfa(self):
        lable = self.get_path()
        end_states = self.get_dfa_end_state()
        # print(end_states)

        f = gv.Digraph('C:/Users/YL139/Desktop/byyl/test/byxt/NFA_DFA_zxhdfa/zxhdfa', format="png")
        f.attr(rankdir='LR', size='8,5')
